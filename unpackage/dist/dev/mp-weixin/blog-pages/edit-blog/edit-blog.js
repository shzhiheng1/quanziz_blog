...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getInfoData = () => {
      db.collection("blogs").where({ "_id": blog_id.value }).get({
        getOne: true
      }).then((res) => {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        y: common_vendor.o(handleStatus),
        z: common_vendor.o(handleInput),
        A: common_vendor.o(($event) => handleSubmit("save")),
        B: common_vendor.p({
          type: "primary",
          text: "保存"
        }),
        ...
        D: common_vendor.o(($event) => handleSubmit("publish")),
        E: common_vendor.p({
          type: "success",
          text: "发布"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-0edcea76"]]);
