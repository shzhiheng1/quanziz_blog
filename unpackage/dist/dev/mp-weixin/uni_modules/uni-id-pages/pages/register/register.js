...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    p: common_vendor.sr("captcha", "747b6459-8,747b6459-7"),
    q: common_vendor.o(($event) => $data.formData.captcha = $event),
    r: common_vendor.p({
      scene: "register",
      modelValue: $data.formData.captcha
    }),
    s: common_vendor.sr("agreements", "747b6459-9,747b6459-0"),
    t: common_vendor.p({
      scope: "register"
    }),
    ...
    x: common_vendor.o((...args) => $options.registerByEmail && $options.registerByEmail(...args)),
    y: common_vendor.o((...args) => $options.toLogin && $options.toLogin(...args)),
    z: common_vendor.sr("form", "747b6459-0"),
    A: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
