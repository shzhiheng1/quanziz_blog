...
if (!Array) {
  ...
  (_easycom_uni_easyinput2 + _easycom_uni_forms_item2 + _easycom_uni_forms2 + _easycom_uni_captcha2 + _easycom_uni_id_pages_agreements2 + _easycom_up_button2)();
}
...
if (!Math) {
  (_easycom_uni_easyinput + _easycom_uni_forms_item + _easycom_uni_forms + _easycom_uni_captcha + _easycom_uni_id_pages_agreements + _easycom_up_button)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    p: common_vendor.o($options.pwdLogin),
    q: common_vendor.p({
      type: "primary"
    }),
    r: !_ctx.config.isAdmin
  }, !_ctx.config.isAdmin ? {
