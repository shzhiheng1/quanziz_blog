...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const handleData = () => {
      const blogTemp = db.collection("blogs").where({ "article_status": 2 }).getTemp();
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-d7a7e600"]]);
